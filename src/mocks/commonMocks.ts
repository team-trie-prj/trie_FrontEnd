...
export const MOCK_DOCUMENTS: StoredDocument[] = [
  { id: 'd1', fileName: '도로파손_응급복구_매뉴얼_v3.pdf', charCount: 145820, chunkCount: 182, domain: '도로', uploadedAt: '2026-06-18T10:12:00Z' },
  { id: 'd2', fileName: '산업현장_안전관리_지침서.docx', charCount: 76400, chunkCount: 96, domain: '안전', uploadedAt: '2026-06-21T14:30:00Z' },
  { id: 'd3', fileName: '교통안전시설_설치기준.pdf', charCount: 198300, chunkCount: 244, domain: '교통', uploadedAt: '2026-06-25T09:05:00Z' },
  { id: 'd4', fileName: '유성구_민원대응_표준절차.pdf', charCount: 45210, chunkCount: 58, domain: '공통', uploadedAt: '2026-06-30T16:44:00Z' },
];
