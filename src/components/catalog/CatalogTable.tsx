  ...
  return (
    <Card className="overflow-hidden p-0">
      <div className="flex items-center justify-between gap-3 px-5 py-4 max-[640px]:flex-col max-[640px]:items-stretch">
        ...
        <div className="flex items-center gap-2 rounded-[10px] border border-line3 bg-panel2 px-3 py-2">
          ...
          <input
            ...
            className="w-[190px] border-none bg-transparent text-[13px] text-ink outline-none placeholder:text-mut4 max-[640px]:w-full"
          />
        </div>
      </div>
      <div className="grid grid-cols-[1fr_100px_120px] border-b border-[#161616] px-5 py-3 text-[11px] tracking-[.1em] text-mut3 max-[640px]:hidden">
        <span>API</span>
        <span>상태</span>
      ...
      {filtered.map((e) => (
        <div
          key={e.id}
          className="grid grid-cols-[1fr_100px_120px] items-center border-b border-[#141414] px-5 py-3.5 last:border-b-0 max-[640px]:grid-cols-1 max-[640px]:gap-1.5"
        >
          ...
          <span className="text-right text-xs text-mut4 max-[640px]:text-left">
