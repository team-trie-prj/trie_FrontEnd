  ...
  return (
    <div className="mx-auto flex w-full max-w-[680px] flex-wrap items-center gap-3 rounded-[30px] border border-line3 bg-panel py-[7px] pl-[22px] pr-[7px] max-[480px]:gap-2 max-[480px]:pl-4">
      ...
      <button
        ...
        disabled={busy}
        className="inline-flex h-[46px] items-center gap-2 rounded-[23px] bg-white px-[22px] text-sm font-semibold text-black hover:bg-[#e9e9e9] disabled:opacity-50 max-[480px]:h-10 max-[480px]:px-4"
      >
        {busy ? <Spinner /> : '검색'}
      </button>
    </div>
