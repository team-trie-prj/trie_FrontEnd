...
export default function Footer() {
  return (
    <footer className="mt-10 border-t border-[#141414] bg-black">
      <div className="mx-auto grid max-w-wrap grid-cols-[1.6fr_1fr_1fr_1fr] gap-[30px] px-9 pb-[30px] pt-[50px] max-[768px]:grid-cols-2 max-[480px]:grid-cols-1 max-[480px]:px-5">
        <div>
